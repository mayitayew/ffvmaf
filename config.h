/* Generated by FFMPEG's configure for wasm specifically (from https://github.com/Yahweasel/libav.js/) - do not modify! */
#ifndef FFMPEG_CONFIG_H
#define FFMPEG_CONFIG_H
#define FFMPEG_CONFIGURATION "--prefix=/opt/ffmpeg --target-os=linux --cc=emcc --ranlib=emranlib --extra-cflags=-I/home/michael/src/libav.js/tmp-inst/include --extra-ldflags=-L/home/michael/src/libav.js/tmp-inst/lib --arch=emscripten --enable-small --disable-doc --disable-stripping --disable-pthreads --disable-programs --disable-ffplay --disable-ffprobe --disable-network --disable-iconv --disable-xlib --disable-sdl2 --disable-everything --enable-protocol=data --enable-protocol=file --enable-filter=aresample --enable-demuxer=ogg --enable-muxer=ogg --enable-demuxer=matroska --enable-muxer=matroska --enable-muxer=webm --enable-demuxer=mov --enable-muxer=ipod --enable-decoder=aac --enable-encoder=aac --enable-decoder=flac --enable-encoder=flac --enable-demuxer=flac --enable-muxer=flac --enable-decoder=pcm_s16le --enable-decoder=pcm_s24le --enable-encoder=pcm_s16le --enable-encoder=pcm_s24le --enable-demuxer=wav --enable-muxer=wav --enable-filter=acompressor --enable-filter=adeclick --enable-filter=adeclip --enable-filter=aecho --enable-filter=afade --enable-filter=aformat --enable-filter=agate --enable-filter=alimiter --enable-filter=amix --enable-filter=apad --enable-filter=atempo --enable-filter=atrim --enable-filter=bandpass --enable-filter=bandreject --enable-filter=dynaudnorm --enable-filter=equalizer --enable-filter=loudnorm --enable-filter=pan --enable-filter=amix --enable-filter=volume --enable-cross-compile --pkg_config-flags=--static"
...
#define CC_IDENT "emcc (Emscripten gcc/clang-like replacement + linker emulating GNU ld) 3.1.10-git (7e9a238be66896046c0f4927b676dcadbce0a74b)"
